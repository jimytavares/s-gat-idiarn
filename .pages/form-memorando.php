        ...
        <div class="app-main">
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <!-- 01 Action Button: Fonte -->
                    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                        <li class="nav-item">
                            <a role="tab" class="nav-link active" id="tab-0" data-toggle="tab" href="#fonte-250">
                                <span>Fonte 250</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a role="tab" class="nav-link" id="tab-1" data-toggle="tab" href="#fonte-281">
                                <span>Fonte 281</span>
                            </a>
                        </li>
                    </ul> 
                    ...
                    <div class="tab-content">
                        ...
                        <!-- 250 -->
                        <div class="tab-pane tabs-animation fade show active" id="fonte-250" role="tabpanel">
                              
                            <div class="alert alert-success" role="alert" style="width:25%; margin-top:22px;">
                              <b>Fonte 250!</b> Selecione agora Vegetal ou Animal. 
                            </div>
                            
                            <!-- 3 buttons -->
                            <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                                <li class="nav-item">
                                    <a role="tab" class="nav-link active" id="tab-0" data-toggle="tab" href="#fonte-250-vegetal">
                                        <span>Vegetal</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a role="tab" class="nav-link" id="tab-1" data-toggle="tab" href="#fonte-250-animal">
                                        <span>Animal</span>
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <!-- 01 FORM: Vegetal -->
                                <div class="tab-pane tabs-animation fade show active" id="fonte-250-vegetal" role="tabpanel">
                                            ...
                                            <form class="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="container">
                                                            <br/>
                                                            <h5 class="card-title" style="color:#3f6ad8;">Formação da Equipe:</h5>
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <label for="exampleFormControlSelect1"><b>1º</b> Beneficiario:</label>
                                                                    <select class="form-control" id="exampleFormControlSelect1" style="margin-top:2px;">
                                                                      <option>..:: SELECIONE ::..</option>
                                                                      <?php include_once('../.control/select_beneficiario.php'); ?>
                                                                    </select>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label for="exampleFormControlSelect2" style="margin-top:15px;"><b>2º</b> Beneficiario:</label>
                                                                    <select class="form-control" id="exampleFormControlSelect2" style="margin-top:2px;">
                                                                      <option>..:: SELECIONE ::..</option>
                                                                      <?php include_once('../.control/select_beneficiario.php'); ?>
                                                                    </select>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label for="exampleFormControlSelect1" style="margin-top:15px;"><b>3º</b> Beneficiario:</label>
                                                                    <select class="form-control" id="exampleFormControlSelect1" style="margin-top:2px;">
                                                                      <option>..:: SELECIONE ::..</option>
                                                                      <?php include_once('../.control/select_beneficiario.php'); ?>
                                                                    </select>
                                                                ...
                                                                <div class="col-12">
                                                                    <label for="exampleFormControlSelect1" style="margin-top:15px;"><b>4º</b> Beneficiario:</label>
                                                                    <select class="form-control" id="exampleFormControlSelect1" style="margin-top:2px;">
                                                                      <option>..:: SELECIONE ::..</option>
                                                                      <?php include_once('../.control/select_beneficiario.php'); ?>
                                                                    </select>
                                                                ...
                                                                <div class="col-12">
                                                                    <label for="exampleFormControlSelect1" style="margin-top:15px;"><b>5º</b> Beneficiario:</label>
                                                                    <select class="form-control" id="exampleFormControlSelect1" style="margin-top:2px;">
                                                                      <option>..:: SELECIONE ::..</option>
                                                                      <?php include_once('../.control/select_beneficiario.php'); ?>
                                                                    </select>
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="container" style="margin-top:14px;">
                                                            <h5 class="card-title" style="color:#3f6ad8;">Destino:</h5>
                                                            <div class="row">
                                                                <!--<div class="col-12">
                                                ...
                                                <fieldset disabled>
                                                    <legend>Total de Diárias:</legend>
                                                    
                                                    <div class="col-12" style="width:25%;">
                                                      <input type="text" id="disabledTextInput" class="form-control" placeholder="Resultado: 1,5">
                                                    </div>
                                                </fieldset>
                                ...
                                <!-- 02 FORM: Animal -->
                                <div class="tab-pane tabs-animation fade" id="fonte-250-animal" role="tabpanel">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                        ...
                        <!-- 281 -->
                        <div class="tab-pane tabs-animation fade" id="fonte-281" role="tabpanel">
                            
                            <div class="alert alert-primary" role="alert" style="width:25%; margin-top:22px;">
                              <b>Fonte 281!</b> Selecione agora Vegetal ou Animal. 
                            </div>
                            
                            <!-- 3 buttons -->
                            <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                                    <li class="nav-item">
                                        <a role="tab" class="nav-link active" id="tab-0" data-toggle="tab" href="#fonte-281-vegetal">
                                            <span>Vegetal</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a role="tab" class="nav-link" id="tab-1" data-toggle="tab" href="#fonte-281-animal">
                                            <span>Animal</span>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="tab-content">
                                    ...
                                    <!-- 01 FORM: Vegetal -->
                                    <div class="tab-pane tabs-animation fade show active" id="fonte-281-vegetal" role="tabpanel">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body">
                                    ...
                                    <!-- 02 FORM: Animal -->
                                    <div class="tab-pane tabs-animation fade" id="fonte-281-animal" role="tabpanel">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body">

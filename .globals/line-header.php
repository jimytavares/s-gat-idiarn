        ...
        <div class="app-header__logo">
            ...
            <div class="row">
                <div class="col-md-auto">
                    <h5 class="logo-src" style="color:#3f6ad8;"><b>IDIARN</b></h5>
                </div>
                <div class="col">
                    <a href="../index.php"><i class="fas fa-home" style="font-size:21px; color:#3f6ad8; padding-top:2px;"></i></a>
                </div>
                <div class="col">
                        ...
                        <div class="widget-content-wrapper">
                            ...
                            <div class="widget-content-left  ml-3 header-user-info">
                                <div class="widget-heading">
                                    Jimy Dickson Jales da Silva
                                </div>
                                <div class="widget-subheading">
                                    <b>Diretor Geral</b> | CPF: 104.081.015-41
                                </div>
                            </div>
